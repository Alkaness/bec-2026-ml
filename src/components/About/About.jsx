        ...
        <div className="cyber-panel p-6 md:p-10 relative">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="space-y-4 text-base md:text-lg leading-relaxed font-sans" style={{ color: 'var(--color-text-muted)' }}>
              ...
              <p>
                У 13 років були нові спроби навчання, але бракувало мотивації, хотілося більше грати в ігри. Проте буквально цього літа я зрозумів, що програмування — це класна штука. За літо та початок осені я прочитав книжки по <span style={{ color: 'var(--color-orange-light)' }}>Python</span> та <span style={{ color: 'var(--color-orange-light)' }}>C/C++</span>. Зараз я вже маю декілька серйозних проєктів, розробляючи які я остаточно усвідомив, що стати <span style={{ color: 'var(--color-primary)' }} className="font-bold">IT-респом</span> у кортімі — це моя ціль №1. Але головна моя мотивація — це стати частиною <span style={{ color: 'var(--color-primary)' }} className="font-bold">кортіми</span> і допомогти зробити цей <span className="shimmer-text font-bold">БЕК</span> найвайбовішим та найкращим. Я бачу реальні шляхи, як можна покращити процеси в самому <span style={{ color: 'var(--color-primary)' }}>БЕКу</span>. Зокрема, я дуже хочу зробити значно ліпшу та стабільнішу реалізацію для <span className="cyber-glitch-text font-bold" style={{ color: 'var(--color-primary)' }}>TD Market</span>. В мене є класна ідея відійти від формату класичного бота і спробувати зробити повноцінну <span style={{ color: 'var(--color-orange)' }} className="font-bold">міні апку в телеграм</span> — це дасть набагато кращий користувацький досвід для учасників. Так команди зможуть максимально зручно та швидко обмінювати свої купони на <span style={{ color: 'var(--color-orange-light)' }}>інженерні матеріали</span>. Робота в такій зарядженій кортімі над створенням крутого івенту — це саме те, що мене зараз мотивує найбільше!
              </p>
